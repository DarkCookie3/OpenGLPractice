...
Shader::Shader(const std::string& filepathVertex, const std::string& filepathGeometry)
{
    ShaderProgramSource source = ParseShader(filepathVertex, filepathGeometry);
...
ShaderProgramSource Shader::ParseShader(const std::string& filepathVertex, const std::string& filepathFragment, const std::string& filepathGeometry)
{
    ...
    try
    {
        ...
        if (filepathGeometry != "")
        {
            gShaderFile.open(filepathGeometry);
    ...
    return ShaderProgramSource(vertexCode, fragmentCode);
}
